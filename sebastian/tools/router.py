...
from sebastian.tools.web_search import search, fetch_page, get_weather
from sebastian.tools.app_control import open_app, open_url, kill_process, launch_steam_game
from sebastian.tools.file_ops import read_file, write_file, list_files
from sebastian.tools.code_exec import run_python
from sebastian.tools.system import (
...
from sebastian.tools.desktop import (
...
from sebastian.tools.subagent import delegate_task
...
TOOL_MAP = {
    ...
    "launch_steam_game": lambda a: launch_steam_game(a["appid"], a.get("name", "")),
...
TOOL_SCHEMAS = [
    ...
    {"type": "function", "function": {
        ...
        "description": "Start an installed Steam game via steam:// (no browser). Steam should already be open. appid e.g. 570 = Dota 2, 730 = CS2.",
        "parameters": {"type": "object", "properties": {
            "appid": {"type": "integer", "description": "Steam app id, e.g. 570"},
            "name": {"type": "string", "description": "Game name for the reply, e.g. Dota 2"}},
            "required": ["appid"]}}},
