...
def read_screen() -> str:
    ...
    tmp = os.path.join(tempfile.gettempdir(), "sebastian_screen.png")
...
def get_open_windows() -> str:
    ...
    return (result.stdout or "").strip() or "No open windows found."
...
def focus_window(title: str) -> str:
    ...
    return f"Focused: {name}" + ("" if fg == hwnd else " (note: Windows blocked focus steal; window restored)")
