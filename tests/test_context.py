...
def _make_ctx(**kwargs):
    with patch("sebastian.context._load_config", return_value=STUB_CONFIG):
...
def test_window_caps_at_max_messages():
    with patch("sebastian.context.chat", return_value="summary"):
...
def test_summarize_called_when_window_fills():
    ...
    with patch("sebastian.context.chat") as mock_chat, \
         patch("sebastian.context._load_config", return_value=STUB_CONFIG):
